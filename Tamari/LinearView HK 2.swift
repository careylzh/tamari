...
//    @State private var buttonRadius: CGFloat = 150
...
//                        if let first = trailPositions.first {
//                            firstPosition = first
//                        }
//                    }
...
//                    }
                ...
                if (startButtonID...endButtonID).contains(sharedState.triggerID) || (startButtonID...endButtonID).contains((sharedState.triggerID - 1)) {
                    Circle()
                        .fill(.blue)
